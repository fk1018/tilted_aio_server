...
import { SAVE_DATA, CREATE_NEW_ACCOUNT, CREATE_NEW_ADDRESS, CREATE_NEW_BROWSER, CREATE_NEW_BROWSER_GROUP, CREATE_NEW_CREDIT_CARD, CREATE_NEW_PROFILE, CREATE_NEW_PROXIES, CREATE_NEW_PROXY_GROUP, UPDATE_ADDRESS_GROUPS, UPDATE_BROWSERS, UPDATE_CREDIT_CARD_GROUPS, UPDATE_PROXIES, UPDATE_PROXY_GROUPS, UPDATE_BROWSER_GROUPS, UPDATE_TASKS } from '../../strings'
